...
class UpdateElementInArrayVisualization:
    ...
    def create_algorithm_page(self):
        """Set up the Update Element in Array algorithm page."""
        ...
        algo_label = tk.Label(
            self.frame,
            text="Update Element in Array Visualization",
        ...
        index_label = tk.Label(
            field_frame, text="Enter position to update (0-indexed):", fg="#ffffff", bg="#1e1e1e"
        )
        index_label.pack(side="left", expand=True, fill="x", padx=20,pady=(10, 5))
        self.index_entry = tk.Entry(entry_frame, width=10)
        self.index_entry.pack(side="left", expand=True, fill="x", padx=20)

        # Input field for target number
        value_label = tk.Label(
            field_frame, text="Enter new value:", fg="#ffffff", bg="#1e1e1e"
        )
        value_label.pack(side="left", expand=True, fill="x", padx=20,pady=(10, 5))
    ...
    def start_operation(self):
        ...
        try:
            ...
            self.update_index = int(self.index_entry.get())
            self.new_value = int(self.value_entry.get())
            if self.update_index < 0 or self.update_index >= len(self.numbers):
        ...
        self.operation_thread = threading.Thread(target=self.update_element_in_array)
        self.operation_thread.start()

    def update_element_in_array(self):
        self.visualize(highlight=self.update_index)
        ...
        # Update the element
        self.numbers[self.update_index] = self.new_value
        self.visualize(highlight=self.update_index, updated=True)
        time.sleep(self.speed)
    ...
    def visualize(self, highlight=None, updated=False):
        self.ax.clear()
        bars = self.ax.bar(range(len(self.numbers)), self.numbers)
        
        if highlight is not None:
            bars[highlight].set_color('r' if not updated else 'g')
        
        self.ax.set_xlabel('Index')
        self.ax.set_ylabel('Value')
        self.ax.set_title('Update Element in Array Visualization')
        self.canvas.draw()
    ...
    def show_documentation(self):
        ...
        doc_window.title("Update Element in Array Documentation")
        ...
        documentation = """
        Update Element in Array Operation Documentation

        This operation updates the value of an element at a specific index in the array.

        Time Complexity:
        - O(1), as it directly accesses and modifies the element at the given index

        Space Complexity: O(1)

        Steps:
        1. Identify the index of the element to be updated.
        2. Replace the value at that index with the new value.

        Visualization Guide:
        - Red bar: Element before update
        - Green bar: Element after update
    ...
    def ask_ai(self):
        ...
        qa = """
        1. what is update element in array
        
        Update Element in Array is an operation that changes the value of an element at a specific index in the array.",
        
        2. what is the time complexity
        
        The time complexity of Update Element in Array is O(1), as it directly accesses and modifies the element at the given index.",
        
        3. how does it work
        
        The operation works by identifying the index of the element to be updated and then replacing the value at that index with the new value.",
        
        4. what are the applications
        
        Updating elements in an array is a fundamental operation used in many algorithms and applications. It's used for tasks such as modifying data, implementing dynamic programming algorithms, and managing game states in array-based representations.",
       """
...
def create_algorithm_page(root, prev_page):
    """Wrapper function to create the Update Element in Array visualization page."""
    UpdateElementInArrayVisualization(root, prev_page)

# If you want to run this file standalone for testing
if __name__ == "__main__":
    root = tk.Tk()
    root.title("Update Element in Array Visualization")
    root.geometry("800x600")
    UpdateElementInArrayVisualization(root, None)
    root.mainloop()
